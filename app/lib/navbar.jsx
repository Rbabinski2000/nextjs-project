        ...
        <header className="fixed top-0 h-[65px] bg-gray-800 text-gray-100 z-50 "style={{ width: '89%' }}>
            <div className="flex items-center justify-between h-full px-4">
                ...
                <div className="hidden lg:flex items-center space-x-4">
                    ...
                    {!user ? (
                        <>
                            <Link href="/user/signin" className="px-4 py-2 bg-violet-600 text-white rounded">Login</Link>
                            <Link href="/user/register" className="px-4 py-2 bg-gray-700 text-white rounded">Register</Link>
                        </>
                    ) : (
                        <Link href="/user/signout" className="px-4 py-2 bg-red-600 text-white rounded">Sign Out</Link>
                    )}
                </div>
