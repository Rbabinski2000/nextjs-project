...
export default function Navbar() {
    ...
    return (
      <header className="h-[64px] w-full bg-gray-800 text-gray-100 z-50 shadow-lg">
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="lg:hidden bg-gray-800 text-gray-100 z-50 block sticky">
            <ul className="space-y-4 px-4 py-2">
              <li>
                <Link href="/" className="block hover:text-violet-600">
                  Home
                </Link>
              </li>
              <li>
            ...
            <div className="px-4 py-2 border-t border-gray-700">
              {user?.email ? (
                ...
                <>
                  <Link
                    href="/user/signin"
                    className="block px-4 py-2 bg-violet-600 text-white rounded mb-2"
                  >
                    Login
                  </Link>
                  <Link
